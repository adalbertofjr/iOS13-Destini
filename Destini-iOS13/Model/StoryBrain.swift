...
struct StoryBrain{
    ...
    mutating func nextStory(_ userChoice: String) {
        switch userChoice {
        case stories[destination].choice1:
            destination = stories[destination].choice1Destination
        case stories[destination].choice2:
            destination = stories[destination].choice2Destination
        default:
           return
        }
    }
